...
namespace ExcelValues
{
	...
	class MainClass
	{
		...
		static void Main(string[] args)
		{
			...
			// reads the Excel file and writes values to console
		...
		{
			Console.WriteLine("Writes to console the values of a Excel file.");
			Console.WriteLine("Usage: ExcelValues  filename");
			Console.WriteLine("");
