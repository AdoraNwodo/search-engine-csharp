...
using Contents = NExcel.Biff.HeaderFooter.Contents;
namespace NExcel
{
	
	/// <summary> Class which represents an Excel header or footer. </summary>
	public sealed class HeaderFooter:NExcel.Biff.HeaderFooter
	{
		...
		//   */
		//  public static class Contents extends NExcel.Biff.HeaderFooter.Contents
		//  {
		////    /**
		////     * The constructor
		////     */
		...
		protected internal override NExcel.Biff.HeaderFooter.Contents createContents()
		{
			return new Contents(this);
		}
		
		/// <summary> Creates internal class of the appropriate type</summary>
		protected internal override NExcel.Biff.HeaderFooter.Contents createContents(string s)
		{
			return new Contents(this, s);
		}
		
		/// <summary> Creates internal class of the appropriate type</summary>
		protected internal override NExcel.Biff.HeaderFooter.Contents createContents(NExcel.Biff.HeaderFooter.Contents c)
		{
